...
<%@ Page Title="Customers Statement Of Account" Language="VB" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeFile="RepSelLoanDetDate.aspx.vb" Inherits="RepSelLoanDetDate" %>

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

            <!--Heading-->
    <div class="text-center mt-2">
        <h4 style="font-weight: bold;">Customers Statement Of Account</h4>
            ...
            <div class="row mt-2">
                <div class="col-lg-12">
                   <div class="form-group" style="">
                       ...
                       <asp:DropDownList ID="DDCustNo" runat="server" CssClass="form-control">
                            <asp:ListItem value="002" >Loan</asp:ListItem>
