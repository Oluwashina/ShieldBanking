...
Partial Class TrialBalanceREP
    ...
    Protected Sub ButClose_Click(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButClose.Click
        'Dim MyRep As New CrystalDecisions.ReportAppServer.EnterpriseReportDocument
        'CrystalReportSource1.MyRep.Close()
    ...
    Protected Sub ButClose_Init(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButClose.Init
    ...
    Protected Sub ButClose_Unload(ByVal sender As Object, ByVal e As System.EventArgs) Handles ButClose.Unload
    ...
    Protected Sub CrystalReportSource2_Load(sender As Object, e As EventArgs) Handles CrystalReportSource2.Load
        Dim myRpt As New CrystalDecisions.CrystalReports.Engine.ReportDocument
        ...
        Try
            ...
            cryRpt.Load(Server.MapPath("DetailTrialBalance.rpt"))
