...
Partial Class CustListing
    ...
    Protected Sub CrystalReportSource1_Init(sender As Object, e As EventArgs) Handles CrystalReportSource1.Init
    ...
    Protected Sub CrystalReportSource1_Load(sender As Object, e As EventArgs) Handles CrystalReportSource1.Load
        ...
        Try
            ...
            cryRpt.Load(Server.MapPath("CustListing.rpt"))
            ...
            Dim MCOUNT, mCustBalBF, mCustBalBF2 As Integer
            MCOUNT = 0
            mCustBalBF = 0
            mCustBalBF2 = 0
            ...
            mySqlDataAdapterBF = New Data.SqlClient.SqlDataAdapter("Select * from CustAcctOpen", myConnectionBF)
            'Else
            'mySqlDataAdapterBF = New Data.OleDb.OleDbDataAdapter("Select * from CustAcctOpen where branchcode='" & Trim(Session("SelectedBranch")) & "'", myConnectionBF)
            'End If
            ...
            mySqlDataAdapterBF.Fill(myDataSetBF, "CustAcctOpen")

            If myDataSetBF.Tables("CustAcctOpen").Rows.Count <= 0 Then
            ...
            ''Dim myRpt As New CrystalDecisions.CrystalReports.Engine.ReportDocument
            'myRpt = New CrystalDecisions.CrystalReports.Engine.ReportDocument
            'myRpt.Load(Server.MapPath("CustListing.rpt"))
            'myRpt.SetDataSource(myDataSetBF)
            ''myRpt.ExportToHttpResponse(ExportFormatType.HTML32, Response, False, "ExportedReport")
