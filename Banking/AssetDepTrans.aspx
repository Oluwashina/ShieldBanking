<%@ Page Language="VB" AutoEventWireup="false" CodeFile="AssetDepTrans.aspx.vb" Inherits="AssetDepTrans" %>
...
<body>
    ...
    <div>
        <a href="AssetDepTrans.aspx">AssetDepTrans.aspx</a><cr:crystalreportviewer id="CrystalReportViewer1" runat="server" autodatabind="True"
...
<Report FileName="AssetDepTrans.rpt"></Report>
