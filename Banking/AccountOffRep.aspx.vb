...
Partial Class AccountOffRep
    ...
    Protected Sub CrystalReportViewer1_Load(sender As Object, e As EventArgs) Handles CrystalReportViewer1.Load
        ...
        Try
            ...
            cryRpt.Load(Server.MapPath("AccountOfficer.rpt"))
            ...
            If myDataSet2.Tables("custacctopen").Rows.Count <= 0 Then
                ClientScript.RegisterStartupScript(Page.GetType(), "TestAlert", "alert('No record found.....');", True)
