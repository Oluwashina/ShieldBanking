<%@ Page Language="VB" AutoEventWireup="false" CodeFile="ProfitLossClass.aspx.vb" Inherits="ProfitLossClass" %>
...
<head runat="server">
    <title>Profit & Loss(Grouped)</title>
...
<body>
    ...
    <div>
        ...
        <CR:CrystalReportSource ID="CrystalReportSource1" runat="server">
            <Report FileName="ProfitLossClass.rpt">
            </Report>
